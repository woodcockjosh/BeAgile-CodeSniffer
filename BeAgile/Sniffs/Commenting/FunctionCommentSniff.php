 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class BeAgile_Sniffs_Commenting_FunctionCommentSniff extends Squiz_Sniffs_Commenting_FunctionCommentSniff
{
        ...
        if ($isSpecialMethod === false && $methodName !== $className) {
            if ($return !== null) {
                ...
                if (empty($content) === true) {
                    ...
                    if ($content !== $suggestedType && $content != 'double') {
        ...
        if (empty($params) === false) {
            ...
            foreach ($params as $param) {
                ...
                foreach ($typeNames as $typeName) {
                    $suggestedName = PHP_CodeSniffer::suggestType($typeName);
                    if ($typeName !== $suggestedName && $typeName != 'double') {
                        ...
                        if ($suggestedTypeHint !== '' && isset($realParams[($pos - 1)]) === true) {
                            ...
                            if ($typeHint === '' && $suggestedTypeHint != 'float') {
