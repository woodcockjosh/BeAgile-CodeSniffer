...
class BeAgile_Sniffs_Commenting_FileCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processLicense($errorPos)
    {
        ...
        if ($license !== null) {
            ...
            if (empty($url) === true && empty($content) === true) {
                ...
                } else if ($url !== $this->licenseURL) {
                    $error = 'Expected ' . $this->licenseURL . ' for license URL';
